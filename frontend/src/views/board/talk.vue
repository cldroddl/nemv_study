...
export default {
  ...
  methods: {
    ...
    list (ctx) {
      ...
      this.sortDesc = ctx.sortDesc
      this.isBusy = true
      const p = this.$axios.get('http://localhost:3000/api/board/talk', {
        params: {
          draw: (this.draw += 1),
          search: this.filter,
          skip: this.setSkip,
    ...
    read (r) {
      ...
      this.isBusy = true
      this.$axios.get(`http://localhost:3000/api/board/talk/${_id}`)
        .then((res) => {
          if (!res.data.success) throw new Error(res.data.msg)
    ...
    add (evt) {
      evt.preventDefault()
      this.$axios.post('http://localhost:3000/api/board/talk', this.form)
        .then((res) => {
          if (!res.data.success) throw new Error(res.data.msg)
    ...
    mod () {
      this.$swal({
        ...
        .then((sv) => {
          ...
          return this.$axios.put('http://localhost:3000/api/board/talk', this.form)
        })
        .then((res) => {
          if (!res.data.success) throw new Error(res.data.msg)
    ...
    del (v) {
      this.$swal({
        ...
        .then((sv) => {
          if (!sv) throw new Error('')
          return this.$axios.delete('http://localhost:3000/api/board/talk', {
            params: { _id: v._id }
          })
        })
        .then((res) => {
    ...
    modifyComment () {
      this.$swal({
        ...
        .then((res) => {
          ...
          return this.$axios.put('http://localhost:3000/api/board/talk/comment', this.formComment)
        })
        .then((res) => {
          if (!res.data.success) throw new Error(res.data.msg)
    ...
    deleteComment (r, cmt, i) {
      this.$swal({
        ...
        .then((res) => {
          if (!res) throw new Error('')
          return this.$axios.delete('http://localhost:3000/api/board/talk/comment', {
            params: { _id: cmt._id }
          })
        })
        .then((res) => {
